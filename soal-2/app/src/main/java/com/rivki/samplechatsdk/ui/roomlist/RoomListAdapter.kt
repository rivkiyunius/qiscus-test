...
class RoomListAdapter(private val diffCallback: DiffCallback = DiffCallback(), private val listener: (QiscusChatRoom) -> Unit) :
    RecyclerView.Adapter<RoomListAdapter.ViewHolder>() {
    private var listChatRoom = mutableListOf<QiscusChatRoom?>()

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val itemViewMessagesBinding = ItemViewMessagesBinding.inflate(LayoutInflater.from(parent.context), parent, false)
